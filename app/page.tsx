...
export default function Home() {
  ...
  const query = async (data) => {
    ...
    const response = await fetch(
      ...
      {
        headers: {
          Authorization: "Bearer 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",
        },
        method: "POST",
  ...
  return (
    ...
    >
      {/* <input onChange={(e)=>setText(e.target.value)} type="text" placeholder="Text-to-Image" className="border border-gray-600 rounded-lg text-gray-700 px-2 py-1 mr-10 "/>
      <button onClick={onClickHandler} className="border border-orange-500 px-2 py-1 rounded-lg hover:bg-orange-500 hover:text-white transition duration-700 ease-in-out ">Generate Image</button>
      <img width={200} height={200} src={url} alt="No-Generated Image" className="mt-10 rounded-md"/> */}
